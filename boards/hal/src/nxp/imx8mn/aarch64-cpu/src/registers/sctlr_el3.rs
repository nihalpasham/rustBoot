...
register_bitfields! {u64,
    pub SCTLR_EL3 [
        ...
        ///
        ///   If the value of SCTLR_EL3.M is 0, instruction accesses from stage 1 of the EL2 or EL2&0
        ...
        ///   HCR_EL3.{E2H, TGE} == {1, 1}, instruction access to Normal memory from EL0.
        ///
        ///   If the value of SCTLR_EL3.M is 0, instruction accesses from stage 1 of the EL2&0
        ///   translation regime are to Normal, Outer Shareable, Inner Write-Through, Outer
        ///   Write-Through memory.
        ///
        /// When EL2 is disabled, and the value of HCR_EL3.{E2H, TGE} is {1, 1}, this bit
        ...
        ///   - When HCR_EL3.{E2H, TGE} != {1, 1}, Normal memory accesses to the EL2 translation tables.
        ///   - When EL2 is enabled in the current Security state and HCR_EL3.{E2H, TGE} == {1, 1}:
        ...
        ///     - Normal memory accesses to the EL2&0 translation tables.
        ///
        /// When EL2 is disabled in the current Security state or HCR_EL3.{E2H, TGE} != {1, 1},
        ...
        /// when EL2 is enabled in the current Security state and HCR_EL3.{E2H, TGE} == {1, 1}, EL0.
        ///
        ...
        ///
        /// 0 - When HCR_EL3.{E2H, TGE} != {1, 1}, EL2 stage 1 address translation disabled.
        ///   - When HCR_EL3.{E2H, TGE} == {1, 1}, EL2&0 stage 1 address translation disabled.
        ///   - See the SCTLR_EL3.I field for the behavior of instruction accesses to Normal memory.
        ///
        /// 1 - When HCR_EL3.{E2H, TGE} != {1, 1}, EL2 stage 1 address translation enabled.
        ///   - When HCR_EL3.{E2H, TGE} == {1, 1}, EL2&0 stage 1 address translation enabled.
        ///
        /// On a Warm reset, in a system where the PE resets into EL2, this field resets to 0.
