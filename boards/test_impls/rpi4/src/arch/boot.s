...
_start:
	...
	// Initialize DRAM or rather, use our linker provided (_bss start & end) symbols 
	ADR_REL	x0, __bss_start
	ADR_REL x1, __bss_end_exclusive

.L_bss_init_loop: // zero out the _bss memory-range 
	cmp	x0, x1
	b.eq	.L_prepare_rust
	stp	xzr, xzr, [x0], #16
	b	.L_bss_init_loop
...
.global	_start  // _start is a declared as a global
