...
use super::drivers::{gicv2::gicv2::GICv2, gpio::GPIO, sdhost::EMMCController, uart0::PL011Uart};
...
pub(crate) static IRQ_CNTLR: GICv2 = unsafe {
    GICv2::new(
        memory_map::map::mmio::GICD_START,
        memory_map::map::mmio::GICC_START,
    )
};
