...
use crate::{bsp, bsp::global::BOOT_CORE_ID, exception, sync, sync::InitStateLock};
use crate::arch::smp;
...
// OS Interface Code
//------------------------------------------------------------------------------
use sync::interface::ReadWriteEx;

impl bsp::drivers::common::interface::DeviceDriver for GICv2 {
    fn compatible(&self) -> &'static str {
        "GICv2 (ARM Generic Interrupt Controller v2)"
    }

    unsafe fn init(&self) -> Result<(), &'static str> {
        if BOOT_CORE_ID == smp::core_id() {
